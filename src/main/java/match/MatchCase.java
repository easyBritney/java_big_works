...
public class MatchCase {
	...
	public static List<BeanCase> MatchCase(String text)
	{
        ...
        Segment standard = StandardTokenizer.SEGMENT.enableCustomDictionary(true).enablePlaceRecognize(true).enableOrganizationRecognize(false);
...
//		}
	...
	public static void main(String[] args) {
        ...
        String text = "朱伟斌联系李仙会并将100g冰毒贩卖给李仙会";
		...
		for(BeanCase Case:cases)
        {
            ...
            System.out.println(Case.getDrugType());
        }
	}
